...
class _StationFinderScreenState extends State<StationFinderScreen> {
  ...
  List<Map<String, dynamic>> get _filteredStations {
    var filtered = _stations.where((station) {
      if (_selectedFilter == 'Open Now' && !station['isOpen']) return false;
      if (_selectedFilter == 'With Restaurant' && !station['services'].contains('Restaurant')) return false;
      if (_selectedFilter == 'With Car Wash' && !station['services'].contains('Car Wash')) return false;
      if (_selectedFilter == 'With ATM' && !station['services'].contains('ATM')) return false;
      return true;
    }).toList();
        ...
        children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(
                      fontSize: 10,
                      fontWeight: FontWeight.w500,
                      color: station['isOpen'] ? Colors.green[700] : Colors.red[700],
                    ),
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: Wrap(
              spacing: 8,
              runSpacing: 4,
              children: station['services'].map<Widget>((service) {
                return Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                  decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.local_gas_station, color: const Color(0xFFE60012)),
                          const SizedBox(width: 12),
                          Text(
                            'Current Price: ',
                            style: GoogleFonts.poppins(
