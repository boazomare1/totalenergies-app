    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          _buildServiceCard(
            'Promotions',
            'View latest offers and deals',
            Icons.local_offer,
            Colors.pink,
            () => _navigateToScreen(const PromotionsScreen()),
          ),
          const SizedBox(height: 12),
          ...
          _buildServiceCard(
            ...
            Icons.inventory_2,
            Colors.indigo,
            () => _navigateToScreen(const ProductsCatalogScreen()),
          ),
          const SizedBox(height: 12),
          ...
          _buildServiceCard(
            ...
            Icons.help_outline,
            Colors.brown,
            () => _navigateToScreen(const SupportCenterScreen()),
          ),
        ],
      ),
    );
