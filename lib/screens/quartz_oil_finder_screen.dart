...
class _QuartzOilFinderScreenState extends State<QuartzOilFinderScreen>
  ...
  final List<Map<String, dynamic>> _carMakes = [
    ...
    {
      'name': 'Ford',
      'models': ['Focus', 'Fusion', 'Escape', 'Explorer'],
    },
    {
      'name': 'BMW',
  ...
  final List<Map<String, dynamic>> _faqs = [
    {
      ...
      'answer':
          'The Quartz product finder helps you find the right engine oil for your vehicle. Simply select your vehicle type, make, model, and year, or search by license plate. You can also search directly by oil name or specifications.',
    },
    {
      'question': 'Where can I buy Quartz engine oils and fluids?',
      'answer':
          'Quartz engine oils and fluids are available at TotalEnergies service stations, authorized dealers, and online through our official partners. Use our station finder to locate the nearest TotalEnergies station.',
    },
    {
      'question': 'What vehicles can I use the product finder tool for?',
      'answer':
          'The Quartz product finder supports cars, trucks, motorcycles, and heavy equipment. We cover most major vehicle brands and models manufactured from 2000 onwards.',
    },
    {
      'question': 'What if my vehicle isn\'t listed in the product finder?',
      'answer':
          'If your vehicle isn\'t listed, you can contact our technical support team or visit a TotalEnergies service station where our experts can help you find the right Quartz oil for your specific vehicle.',
    },
    {
      'question': 'What makes Quartz engine oil different from other brands?',
      'answer':
          'Quartz engine oils are formulated with advanced technology to provide superior protection, improved fuel economy, and extended engine life. They meet and exceed international standards and are specifically designed for African driving conditions.',
    },
    {
      'question': 'What type of oil does my car need?',
      'answer':
          'The type of oil your car needs depends on several factors including engine type, age, driving conditions, and manufacturer specifications. Use our product finder or consult your vehicle manual for the recommended oil grade and viscosity.',
    },
    {
      'question': 'Popular oil types for cars',
      'answer':
          'Popular Quartz oil types for cars include:\n• Quartz 7000 5W-30 (Synthetic)\n• Quartz 5000 10W-40 (Semi-synthetic)\n• Quartz 3000 15W-40 (Mineral)\n• Quartz 9000 0W-20 (Full synthetic)',
    },
    {
      'question': 'Oil options for motorcycles',
      'answer':
          'For motorcycles, Quartz offers specialized oils including:\n• Quartz Moto 4T 10W-40 (4-stroke engines)\n• Quartz Moto 2T (2-stroke engines)\n• Quartz Moto Racing 10W-50 (High-performance)',
    },
    {
      'question': 'Are synthetic oils better than mineral oils?',
      'answer':
          'Synthetic oils generally offer better performance, longer service intervals, and superior protection in extreme temperatures. However, the best choice depends on your vehicle\'s requirements, driving conditions, and budget. Our product finder will recommend the most suitable option.',
    },
    {
      'question': 'How often should I check my oil?',
      'answer':
          'Check your engine oil level at least once a month or before long trips. For most vehicles, oil changes are recommended every 5,000-10,000 kilometers or every 6 months, whichever comes first. Check your owner\'s manual for specific recommendations.',
    },
    {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [const Color(0xFFE60012), const Color(0xFFC5000F)],
                    ...
                    children: [
                      ...
                      if (title == 'Make' && _selectedMake.isNotEmpty)
                        ...
                        Text(
                          title == 'Cars'
                              ? 'Select vehicle type'
                              : 'Type or select ${title.toLowerCase()}',
                          style: GoogleFonts.poppins(
                            fontSize: 14,
                            color: Colors.grey[500],
                          ),
  ...
  void _showModelDialog() {
    ...
    final selectedMakeData = _carMakes.firstWhere(
      (make) => make['name'] == _selectedMake,
    );
  ...
  void _searchOilByName(String oilName) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Searching for: $oilName', style: GoogleFonts.poppins()),
      ),
    );
  }
}
